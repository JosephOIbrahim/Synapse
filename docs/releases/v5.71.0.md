...
- Panel seat suite, hython 22.0.400 offscreen: **6 failed, 200 passed, 45 warnings in 71.97s (0:01:11)** — five known reds plus ONE NEW, named and diagnosed in `harness/notes/release-5.71.0/SEAT_REDS.md`.
- Installer unit checks: **37 passed, 1 warning in 6.36s**
- Installer qualification: **19/19 PASS, exit 0** against the isolated TestSetup, which carries the
  same payload sha256 as the published Setup (`bc959b26b00b`).
