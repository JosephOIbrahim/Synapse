...
- Panel seat suite, hython 22.0.400 offscreen: **6 failed, 200 passed, 47 warnings in 72.39s (0:01:12)**
- Installer unit checks: **37 passed, 1 warning in 6.62s**
- Installer qualification: **19/19 PASS, exit 0** against the isolated TestSetup, which carries the same
  payload sha256 as the published Setup (`44a2d3c3e20b`).
