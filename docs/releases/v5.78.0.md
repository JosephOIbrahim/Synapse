...
**Product change.** Twelve files under `python/synapse/`, +537/-1704, eleven of them code and the twelfth the version string in `__init__.py` (`python scripts/product_surface.py --diff v5.77.1 HEAD`). Three changes you will notice in the panel, two you will not, and one deletion.
