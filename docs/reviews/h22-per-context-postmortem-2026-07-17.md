...
**Date:** 2026-07-17
**Baseline:** SYNAPSE v5.28.0 (HEAD `72de5f1`, tag `v5.28.0`) · Houdini **22.0.368** live
...
| **Memory / substrate** | MODERATE | Lossless USD round-trip survived the 0.26.5 reorg at **fidelity 1.0, VERIFIED-LIVE**. | The probed path is a **caller-less library**; the (deprecated) module an artist actually fires is a different, unprobed path. *[full analyst section_md was truncated in dispatch — see §4.]* |
