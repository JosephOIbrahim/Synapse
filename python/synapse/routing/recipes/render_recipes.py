            ...
            RecipeStep(
                ...
                payload_template={
                    "code": (
                        ...
                        "# Key light (generic light LOP, rect shape)\n"
                        ...
                        "fill.parm('ry').set(-45)\n"
                        "# Camera\n"
                        "cam = stage.createNode('camera', 'lookdev_cam')\n"
                        "cam.parm('tx').set(0)\n"
                        "cam.parm('ty').set(1)\n"
                        "cam.parm('tz').set(5)\n"
                        "cam.parm('rx').set(-10)\n"
                        "cam.parm('focalLength').set(85)\n"
            ...
            RecipeStep(
                ...
                payload_template={
                    "code": (
                        ...
                        "\n"
                        "# --- USD Render ROP (Karma) ---\n"
                        "karma = stage.createNode('usdrender_rop', 'karma_render')\n"
                        "karma.setInput(0, rs)\n"
                        "karma.parm('override_camera').set('/cameras/turntable_cam')\n"
                        "karma.parm('outputimage').set("
            ...
            RecipeStep(
                ...
                payload_template={
                    "code": (
                        ...
                        "    karma = stage.createNode('usdrender_rop', 'karma_render')\n"
                        "    karma.setInput(0, rs)\n"
                        "    karma.parm('override_camera').set('/cameras/' + cam_name)\n"
                        "    karma.parm('outputimage').set("
                        "'$HIP/render/$HIPNAME/$HIPNAME.$F4.exr')\n"
                        "\n"
                        "    stage.layoutChildren()\n"
