# status_bp1.py - one-pass BP1 board: leg branches ahead-count, receipt
...
def main():
    print("== BP1 BATTLEPLAN board ==")
    pid_file = REPO / "harness" / "notes" / "h22" / "orchestrator-bp1.pid"
    if pid_file.exists():
