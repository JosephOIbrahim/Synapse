...
DERIVED = {
    "755": "price_derived.steady_state_saving_bte_per_call, rounded to whole BTE",
    "860": "price_derived.before_bte_per_call",
    "105": "price_derived.after_bte_per_call, rounded",
    "358": "net_as_shipped, reported as a magnitude",
    "240": "net_lean, reported as a magnitude",
    "1.52": "as_shipped_tokens / tone_alone_tokens",
    "1.35": "lean_tokens / tone_alone_tokens",
    "138": "the schema's pre-repair size minus its current one, 1184 - 1046",
    "1,184": "the PRE-REPAIR schema size, named in the post-repair note (V2-F13)",
    ...
    "5192": "suite after — pytest, recorded in the receipt",
    "137": "suite skipped — pytest, recorded in the receipt",
    "161": "the tests this leg adds, 5192 - 5031",
    ...
    "27": "adversarial findings upheld",
    "10": "voice rules",
    "13": "count_tokens calls",
    "0": "survivors / failures",
    "3": "tiers, and the attempt budget",
    "4": "provenance rungs",
    "96": "MAX_TEXT_CHARS — the by.reason ceiling named in V2-F13",
    "688": "tone guide",
    "65": "schema prose",
    "981": "schema structure",
    "928": "schema lean",
    "1,046": "schema as shipped",
}
