# spawn_compile.py - BASTION harness v2. Dynamic edges, gated. FORK of
# harness/autorevise/spawn_compile.py (traced 2026-08-17, W8-SMITH). Reads a wave
# receipt, validates its spawn[] proposals (v2 schema, so a spawned mission may
# carry skills[]), and compiles them into legs/v1 rows:
