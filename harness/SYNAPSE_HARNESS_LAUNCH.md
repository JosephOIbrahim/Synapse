...
| Generator (WIP=1) | a fresh FORGE instance fills **one Mile's** stubs, atomic commit | **RELAY COMPLETE** ✅ — Mile 1 · Mile 2 · Mile 3 (build half, live-verified on 21.0.671; shipped in v5.19.0) |
