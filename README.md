...
<p align="center"><sub>v5.67.1 · Houdini 22.0.400 (doc pin — the symbol gate re-stamps per running build) · Python 3.13 = the Houdini runtime (hython) · 3.14 = the stock test gate · USD 0.26.5 · PySide6<br>tags: v5.67.1 is Latest · vNEXT tags only via the release ritual (g-receipts are human acts)</sub></p>
