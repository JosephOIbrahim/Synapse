...
<p align="center"><sub>v5.56.0 · Houdini 22.0.400 (doc pin — the symbol gate re-stamps per running build) · Python 3.13 · USD 0.26.5 · PySide6<br>tags: v5.56.0 is latest · vNEXT tags only via the release ritual (g-receipts are human acts)</sub></p>
