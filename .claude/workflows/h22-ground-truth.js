...
const ITEMS = [
  ...
  { key: 'readme-claims', q: 'Audit README.md (repo root) for the G7 worklist: (a) any setx ANTHROPIC_API_KEY instruction, (b) outside-in framing language, (c) badge/version/test-count claims vs VERSION file and harness/verify/suite_baseline.json, (d) presence/absence of a loopback-only security sentence, (e) any description of Moneta as a memory service. Report each with line numbers.' },
